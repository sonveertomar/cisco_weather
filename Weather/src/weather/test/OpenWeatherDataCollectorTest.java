...
import weather.open.OpenWeatherDataCollector;




public class OpenWeatherDataCollectorTest {
	public static void main(String aa[]) {
		...
		OpenWeatherDataCollector OBJ=new OpenWeatherDataCollector();
		ArrayList<String> resp=OBJ.getWeatherData("25.61","85.14139");
